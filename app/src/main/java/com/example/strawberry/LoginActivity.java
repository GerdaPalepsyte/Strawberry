...
public class LoginActivity extends AppCompatActivity {
    ...
    public void onForgot(View view){
        ...
        Intent mainIntent = new Intent(LoginActivity.this, PasswordReset.class);
        LoginActivity.this.startActivity(mainIntent, ActivityOptions.makeSceneTransitionAnimation(this).toBundle());
    }
